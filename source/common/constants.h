...
extern double vca_lambda_tab[QP_MAX_MAX + 1];
extern double vca_lambda2_tab[QP_MAX_MAX + 1];
extern const uint16_t vca_chroma_lambda2_offset_tab[MAX_CHROMA_LAMBDA_OFFSET + 1];
