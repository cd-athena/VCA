...
#define VCA_MAX3(a, b, c) VCA_MAX((a), VCA_MAX((b), (c)))
#define VCA_MIN4(a, b, c, d) VCA_MIN((a), VCA_MIN3((b), (c), (d)))
#define VCA_MAX4(a, b, c, d) VCA_MAX((a), VCA_MAX3((b), (c), (d)))
#define QP_BD_OFFSET (6 * (VCA_DEPTH - 8))
#define MAX_CHROMA_LAMBDA_OFFSET 36

// arbitrary, but low because SATD scores are 1/4 normal
#define VCA_LOOKAHEAD_QP (12 + QP_BD_OFFSET)
...
#define VCA_LOWRES_CU_SIZE   8
#define VCA_LOWRES_CU_BITS   3
...
#if defined(_MSC_VER)
#define VCA_LOG2F(x) (logf((float)(x)) * 1.44269504088896405f)
#define VCA_LOG2(x) (log((double)(x)) * 1.4426950408889640513713538072172)
#else
#define VCA_LOG2F(x) log2f(x)
#define VCA_LOG2(x)  log2(x)
#endif
...
#define VCA_MAX_PRED_MODE_PER_CTU 85 * 2 * 8
...
#define PIXEL_MAX ((1 << VCA_DEPTH) - 1)
...
#define MAX_NUM_DYN_REFINE          (NUM_CU_DEPTH * VCA_REFINE_INTER_LEVELS)
